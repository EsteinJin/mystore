...
Prerequisites
You will create a simple Spree project called mystore. Before you can start building the application, you need to make sure that you have Rails itself installed.
...
This tutorial is part of a series. The next tutorial in this series is the Extensions Tutorial.
